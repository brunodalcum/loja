...
class PostController extends Controller
{
    ...
    public function BlogCatStore(Request $request){
        ...
        $notification=array(
            'messege'=>'Categoria do Blog, Adicionada com Sucesso!',
            'alert-type'=>'success'
        );
    ...
    public function DeleteBlogCat($id){
        ...
        $notification=array(
            'messege'=>'Categoria do Blog Excluída com Sucesso!',
            'alert-type'=>'success'
        );
        return Redirect()->back()->with($notification);
    ...
    public function UpdateBlogCat(Request $request,$id){
        ...
        $notification=array(
            'messege'=>'Atualização Categoria Blog com Sucesso!',
            'alert-type'=>'success'
        );
    ...
    public function store(Request $request){
        ...
        if ($post_image) {
            ...
            $notification=array(
                'messege'=>'Post Inserido com Sucesso',
                'alert-type'=>'success'
            );
            return Redirect()->back()->with($notification);
            ...
            DB::table('posts')->insert($data);
            $notification=array(
                'messege'=>'Post Inserido sem Imagem',
                'alert-type'=>'success'
            );
            return Redirect()->back()->with($notification);
    ...
    public function DeletePost($id){
        ...
        $notification=array(
            'messege'=>'Post Excluído com Sucesso',
            'alert-type'=>'success'
        );
        return Redirect()->back()->with($notification);
    ...
    public function UpdatePost(Request $request,$id){
        ...
        if ($post_image) {
            ...
            $notification=array(
                'messege'=>'Post Atualizado com Sucesso!',
                'alert-type'=>'success'
            );
            ...
            DB::table('posts')->where('id',$id)->update($data);
            $notification=array(
                'messege'=>'Post Atualizado sem Imagem!',
                'alert-type'=>'success'
            );
            return Redirect()->route('all.blogpost')->with($notification);
