...
class BrandController extends Controller
{
    ...
    public function storebrand(Request $request){
        ...
        if ($image) {
            ...
            $notification=array(
                'messege'=>'Marca adicionada com sucesso!',
                'alert-type'=>'success'
            );
    ...
    public function DeleteBrand($id){
        ...
        $notification=array(
            'messege'=>'Marca deletada com sucesso!',
            'alert-type'=>'success'
        );
        return Redirect()->back()->with($notification);
    }
    ...
    public function UpdateBrand(Request $request, $id)
    {
        ...
        if ($image) {
            ...
            $notification = array(
                'messege' => 'Marca Alterada com sucesso',
                'alert-type' => 'success'
            );
            ...
            $brand = DB::table('brands')->where('id', $id)->update($data);
            $notification = array(
                'messege' => 'Atualização sem imagem',
                'alert-type' => 'success'
            );
            return Redirect()->route('brands')->with($notification);
        }
