							...
							<div class="table-responsive">
								<table class="table table-bordered text-nowrap data-table" >
									...
									<tr>
										...
										<th class="wd-15p border-bottom-0">Nome da Marca</th>
										<th class="wd-20p border-bottom-0">Marca Meta Link</th>
									...
									<tr>
										...
										<td><i class="fa fa-chain"></i>&nbsp;<?php echo $marca->marca_meta_link; ?></td>
										<td><?php echo formata_data_banco_com_hora($marca->marca_data_criacao); ?></td>
										<td><?php echo ($marca->marca_ativa == 1 ? '<a href="javascript:void(0)" class="btn btn-green">Sim</a>' : '<a href="javascript:void(0)" class="btn btn-red">Não</a>'); ?></td>



										<td>
											<a href="<?php echo base_url('restrita/marcas/core/'.$marca->marca_id); ?>" class="btn btn-azure">Editar</a>
											<a href="<?php echo base_url('restrita/marcas/delete/'.$marca->marca_id);?>" class="btn btn-red delete" data-confirm="Tem certeza que deseja a exclusão da Marca?">Excluir</a>
										</td>
