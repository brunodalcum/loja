<div class="app-sidebar app-sidebar2">
	<div class="app-sidebar__logo">
		<a class="header-brand" href="index.html">
			<img src="../../assets/images/brand/logo.png" class="header-brand-img desktop-lgo" alt="Covido logo">
	...
	<ul class="side-menu">
		<li class="slide">
			<a class="side-menu__item"  data-bs-toggle="slide" href="javascript:void(0)">
				...
				<span class="side-menu__label">Home</span><i class="angle fa fa-angle-right"></i></a>
			<ul class="slide-menu">
				<li class="side-menu-label1">
					<a href="javascript:void(0)"></a>Home</li>
				<li><a class="slide-item"  href="<?php echo base_url('restrita/usuarios'); ?>"><span>Home</span></a></li>
			</ul>
		</li>
		<li class="slide">
			<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
				...
				<span href="javascript:void(0)" class="side-menu__label">Usuários</span><i class="angle fa fa-angle-right"></i></a>
			<ul class="slide-menu">
				<li class="sub-slide">
				<li class="side-menu-label1">
					<a href="javascript:void(0)"></a>Usuários</li>
				<li><a href="<?php echo base_url('restrita/usuarios'); ?>" class="slide-item">Todos Usuários</a></li>
		...
		<li class="slide">
			...
			<ul class="slide-menu">
				<li class="side-menu-label1">
					<a href="javascript:void(0)"></a>Marcas</li>
				<li><a href="<?php echo base_url('restrita/marcas'); ?>" class="slide-item">Todas as Marcas</a></li>
		...
		<li class="slide">
			<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
				...
				<span class="side-menu__label">Categorias</span><i class="angle fa fa-angle-right"></i></a>
			<ul class="slide-menu">
				<li class="side-menu-label1">
					<a href="javascript:void(0)"></a>Categorias</li>
				<li><a href="<?php echo base_url('restrita/master'); ?>" class="slide-item">Categorias Pai</a></li>
				<li><a href="<?php echo base_url('restrita/categorias'); ?>" class="slide-item">Categorias Filhas</a></li>
			</ul>
		</li>
		<li class="slide">
			<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
				...
				<span class="side-menu__label">Produtos</span><i class="angle fa fa-angle-right"></i></a>
			<ul class="slide-menu">
				<li class="side-menu-label1">
					<a href="javascript:void(0)"></a>Produtos</li>
				<li><a href="<?php echo base_url('restrita/produtos'); ?>" class="slide-item">Todos os Produtos</a></li>
		...
		<li class="slide">
			<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
				...
				<span class="side-menu__label">Configurações</span><i class="angle fa fa-angle-right"></i></a>
			<ul class="slide-menu">
				<li class="side-menu-label1">
					<a href="javascript:void(0)"></a>Sistema</li>
				<li><a href="<?php echo base_url('restrita/sistema');?>" class="slide-item">Neto Suplementos</a></li>
			...
			<div class="help d-flex">
				...
				<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow p-4">
					<div class="border-bottom pb-3">
						...
						<a class="text-primary d-block" href="javascript:void(0)">Knowledge base</a>
						<a class="text-primary d-block" href="javascript:void(0)">Contact@info.com</a>
						<a class="text-primary d-block" href="javascript:void(0)">88 8888 8888</a>
					</div>
					...
					<a class="text-primary" href="<?php echo base_url('restrita/login/logout');?>">Logout</a>
				</div>
				<div class="ms-auto">
				...
				<div class="d-flex">
					...
					<div class="dropdown  header-option">
						...
						<div class="dropdown-menu dropdown-menu-start dropdown-menu-arrow animated">
							...
							<div class="text-start pe-5 ps-5 p-2 border-top">
					...
					<div class="d-flex order-lg-2 ms-auto">
						...
						<div class="dropdown   header-fullscreen ps-4" >
						...
						<div class="dropdown header-notify ps-3">
							<a class="nav-link icon p-0" data-bs-toggle="dropdown">
								<svg class="header-icon" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false"><path opacity=".3" d="M12 6.5c-2.49 0-4 2.02-4 4.5v6h8v-6c0-2.48-1.51-4.5-4-4.5z"></path><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-11c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2v-5zm-2 6H8v-6c0-2.48 1.51-4.5 4-4.5s4 2.02 4 4.5v6zM7.58 4.08L6.15 2.65C3.75 4.48 2.17 7.3 2.03 10.5h2a8.445 8.445 0 013.55-6.42zm12.39 6.42h2c-.15-3.2-1.73-6.02-4.12-7.85l-1.42 1.43a8.495 8.495 0 013.54 6.42z"></path></svg>
								<span class="pulse "></span>
							</a>
							<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow  animated">
								...
								<div class=" text-center p-2 border-top">
									<a href="javascript:void(0)" class="">View All Notifications</a>
								</div>
							</div>
						</div>
						<div class="dropdown profile-dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
								...
								<a class="dropdown-item d-flex" href="<?php echo base_url('restrita/login/logout'); ?>">
									<svg class="header-icon me-3" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
