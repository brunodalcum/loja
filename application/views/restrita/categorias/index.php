					...
					<div class="card">
						<div class="card-header d-block">
							...
							<div class="text-lg-end mt-4 mt-lg-0">
								...
								<a href="<?php echo base_url('restrita/categorias/core'); ?>" class="btn btn-primary">Cadastrar</a>
							</div>
						</div>
						<div class="card-body">
							...
							<div class="table-responsive">
								<table class="table table-bordered text-nowrap data-table" >
									...
									<tr>
										...
										<td><i class="fa fa-chain"></i>&nbsp;<?php echo $categoria->categoria_meta_link; ?></td>
										<td><?php echo formata_data_banco_com_hora($categoria->categoria_data_criacao); ?></td>
										<td><?php echo ($categoria->categoria_ativa == 1 ? '<a href="javascript:void(0)" class="btn btn-green">Sim</a>' : '<a href="javascript:void(0)" class="btn btn-red">Não</a>'); ?></td>



										<td>
											<a href="<?php echo base_url('restrita/categorias/core/'.$categoria->categoria_id); ?>" class="btn btn-azure">Editar</a>
											<a href="<?php echo base_url('restrita/categorias/delete/'.$categoria->categoria_id);?>" class="btn btn-red delete" data-confirm="Tem certeza que deseja a exclusão da Marca?">Excluir</a>
										</td>
