                ...
                <div class="main_nav_content d-flex flex-row">
                    ...
                    <div class="main_nav_menu ml-auto">
                        <ul class="standard_dropdown main_nav_dropdown">
                            <li><a href="{{ route('home') }}">Página Inicial<i class="fas fa-chevron-down"></i></a></li>
                            <li class="hassubs">
...
@php
$slider = \Illuminate\Support\Facades\DB::table('products')
        ...
        <div class="row fill_height">
            ...
            <div class="col-lg-5 offset-lg-4 fill_height">
                <div class="banner_content">
                    ...
                    <h2>R$ {{ $slider->selling_price }}</h2>
                    @else

                        <span>R$ R$ {{ $slider->selling_price }}</span>R$ {{ $slider->discount_price }}</div>
                    @endif

                    <div class="banner_product_name">{{ $slider->brand_name }}</div>
                    <div class="button banner_button"><a href="#">Compre Agora</a></div>
                </div>
            </div>
        </div>
    </div>
