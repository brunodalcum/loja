    ...
    <div class="deals_featured">
     ...
     <button class="product_cart_button addcart" data-id="{{ $row->id }}">Add to Cart</button>
                                                    ...
                                                    <div class="product_extras">
                                                        ...
                                                        <button id="{{ $row->id }}" class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">Add ao Carrinho</button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                    ...
                                                    <div class="product_content">
                                                        ...
                                                        <div class="product_extras">
                                                            ...
                                                            <button class="product_cart_button">Add ao Carrinho</button>
                                                        </div>
                                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="trends_container">
                        <h2 class="trends_title">Compre Um e Ganhe Outro</h2>
                                    ...
                                    <div class="trends_item is_new">
                                        ...
                                        <div class="trends_content">
                                            ...
                                            <div class="trends_info clearfix">
                                                ...
                                                <a href="" class="btn btn-danger btn-sm">Add ao Carrinho</a>
                                            </div>
                                        </div>
                                        <ul class="trends_marks">

                                            <li class="trends_mark trends_new">Compre</li>
                                        </ul>
                                        <button class="addwishlist" data-id="{{ $row->id }}" >
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLavel">Visão do Produto</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="list-group">
                                <li class="list-group-item">Código do Produto:<span id="pcode"></span> </li>
                                <li class="list-group-item">Categoria: <span id="pcat"></span></li>
                                <li class="list-group-item">Sub-categoria: <span id="psub"></span></li>
                                <li class="list-group-item">Marca:<span id="pbrand"></span> </li>
                                <li class="list-group-item">Estoque: <span class="badge" style="background: green;color: white;" >Disponível</span> </li>
                            </ul>
                        ...
                        <div class="col-md-4">
                            ...
                            <form method="post" action="{{ route('insert.into.cart') }}">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputcolor">Tamanho</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputcolor">Quantidade</label>
