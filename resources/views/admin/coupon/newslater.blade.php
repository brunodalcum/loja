 ...
 <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Lista de Assinantes
  <a href="#" class="btn btn-sm btn-warning" style="float: right;" data-toggle="modal" data-target="#modaldemo3">Deletar Todos</a>
          </h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Tempo de Assinatura</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{ URL::to('delete/sub/'.$row->id) }}" class="btn btn-sm btn-danger" id="delete">Excluir</a>
                  </td>
