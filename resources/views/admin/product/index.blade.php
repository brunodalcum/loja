    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Lista de Produtos
                    <a href="{{ route('add.product') }}" class="btn btn-sm btn-warning" style="float: right;">Adicionar Novo</a>
                </h6>
                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        <thead>
                        <tr>
                            <th class="wd-15p">Código do Produto</th>
                            <th class="wd-15p">Nome do Produto</th>
                            <th class="wd-15p">Imagem</th>
                            <th class="wd-15p">Categoria</th>
                            <th class="wd-15p">Marca</th>
                            <th class="wd-15p">Quantidade</th>
