    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Novo Produto ADD</h6>
                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="product_name" value="Calça Jeans" placeholder="Digite o Nome do Produto">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="form-control-label">Código do Produto: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="product_code" value="Jacob" placeholder="Digite o Código">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control"  id="summernote" name="product_details" placeholder="Detalhes do Produto">
                            </div>
                        </div><!-- col-4 -->
