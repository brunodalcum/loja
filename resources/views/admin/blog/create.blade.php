...
@section('admin_content')
 ...
 <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Adicionar Novo Post
 <a href="{{ route('all.blogpost')}}" class="btn btn-success btn-sm pull-right"> Todos os Posts</a>
          </h6>
          <p class="mg-b-20 mg-sm-b-30">Nova Postagem de: </p>
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Título do Post: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="post_title_en"  placeholder="Digite o título do post">
                </div>
              </div><!-- col-4 -->
...
<br><br>
            ...
            <div class="form-layout-footer">
              <button class="btn btn-info mg-r-5" type="submit">Enviar Post</button>
