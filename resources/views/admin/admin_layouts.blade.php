...
@else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>Jacob Jeans</a></div>
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('categories') }}" class="nav-link">Categoria</a></li>
                <li class="nav-item"><a href="{{ route('sub.categories') }}" class="nav-link">Sub Categoria</a></li>
                <li class="nav-item"><a href="{{ route('brands') }}" class="nav-link">Marca</a></li>
            </ul>
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('admin.coupon') }}" class="nav-link">Cupons</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('add.product') }}" class="nav-link">Adicionar Produto</a></li>
                <li class="nav-item"><a href="{{ route('all.product') }}" class="nav-link">Todos os Produtos</a></li>
            </ul>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('add.blog.categorylist') }}" class="nav-link">Blog Categorias</a></li>
                <li class="nav-item"><a href="{{ route('add.blogpost') }}" class="nav-link">Adicionar Post</a></li>
                <li class="nav-item"><a href="{{ route('all.blogpost') }}" class="nav-link">Todos os Posts</a></li>
            </ul>

            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
                    <span class="menu-item-label">Outros</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-header wd-200">
                        <ul class="list-unstyled user-profile-nav">
                            ...
                            <li><a href="{{ route('admin.password.change') }}"><i class="icon ion-ios-gear-outline"></i> Alterar Senha</a></li>
